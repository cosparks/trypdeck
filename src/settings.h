...
#define PULL_TO_PRE_REVEAL_TIME 6000	// amount of time between chain pull (on any pi) and pre-reveal state
#define PRE_REVEAL_TO_REVEAL_TIME 800	// amount of time between pre-reveal and reveal state
